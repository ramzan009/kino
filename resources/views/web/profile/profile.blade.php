...
@section('content')
    @vite(['resources/sass/profile/edit.scss'])
    <div class="container">
        <div class="main-body">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{route('profile_edit')}}" data-mdb-button-init data-mdb-ripple-init
                                       class="btn btn-primary">Изменить данные</a>
                                    <a href="{{ route('logout') }}" data-mdb-button-init data-mdb-ripple-init
                                       class="btn btn-primary">Выйта из аккаунта</a>
                                </div>
                            </div>
                        </div>
                    </div>
